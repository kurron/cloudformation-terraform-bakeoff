...
Service:
    ...
    Properties:
        ...
        TaskDefinition:
            Ref: TaskDefinition
```
I bring up templating only to note that CloudFormation does not appear to have the capability, but it could be that they don't ever expect you to need it.
