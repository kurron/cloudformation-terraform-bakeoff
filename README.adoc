...
Although CloudFormation's peer review workflow isn't as streamlined as Terraform, it at least exists. Although a bit cumbersome, people can check each others work by pulling up the console and eyeballing things.
